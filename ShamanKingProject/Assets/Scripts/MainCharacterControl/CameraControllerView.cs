...
public class CameraControllerView : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameManager.Instance.MainGameEvent.SetSubscribe(GameManager.Instance.MainGameEvent.OnAimingButtonTrigger, cmd => { Debug.LogError("Aimingggggggggggggggggggggg!!!"); });
        ...
        GameManager.Instance.MainGameEvent.SetSubscribe(GameManager.Instance.MainGameEvent.OnSystemCallPlayerGameover, cmd => { canMove_ = false; nowRotateGamepadValue_ = Vector2.zero; });
