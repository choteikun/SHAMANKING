...
namespace AI.FSM.Activities
{
    ...
    public class MovementActivity : Activity
    {
        public override void Enter(BaseStateMachine stateMachine)
        {
            ...
            if(stateMachine.GetComponent<ZombieStats>() != null)//如果敵人身上有ZombieStats腳本
            {
                stateMachine.GetComponent<ZombieStats>().randomTimeToDazeValueTrigger = true;
                stateMachine.GetComponent<ZombieStats>().randomTimeToMoveValueTrigger = true;
            }
        }
