...
namespace Gamemanager
{
    ...
    public class PlayerUltimatePrepareSuccess : GameEventMessageBase 
    {
    ...
    public class SystemCallCinematicPlayCommand:GameEventMessageBase
    {
    ...
    public class BossCallFlameThrowerCommand:GameEventMessageBase
    {

    }
    public class BossCallDashCommand:GameEventMessageBase
    {
