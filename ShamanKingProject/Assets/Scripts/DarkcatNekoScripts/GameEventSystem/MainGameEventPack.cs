...
public class MainGameEventPack : GameEventPack
{
    ...
    public IObservable<PlayerChargeSwitchCommand> OnPlayerChargeSwitch => getSubject<PlayerChargeSwitchCommand>();
    ...
    public IObservable<GhostKilledCommand> OnGhostKilled => getSubject<GhostKilledCommand>();
